...
var DirectionsRenderer = {
  ...
  googleMapsReady: function googleMapsReady() {
    ...
    this.bindProps(this.$_polyline, boundProps$6);
    this.redirectEvents(this.$_polyline, redirectedEvents$6);
  },
  beforeDestroy: function beforeDestroy() {
...
var DirectionsService = {
  ...
  methods: {
    ...
    update: function update() {
      ...
      this.loading = true;
      this.$_directionsService.route(this.request, function (results, status) {
        _this.setResults(results, status);
...
var Directions = {
  ...
  computed: {
    ...
    directionsRendererOptions: function directionsRendererOptions() {
      return {
        options: _objectSpread2({}, this.directions && {
...
export { Circle, Directions, Geocoder, __vue_component__ as Map, MapElement, Marker, NearbyPlaces, PlaceDetails, Polygon, Polyline, Rectangle, UserPosition };
